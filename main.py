...
#configure flask login log in manager
...
def register():
    if request.method=="POST":
        ...
        #hasig and salting the password enterer by user:
...
def login():
    if request.method == "POST":
        ...
        #email doesnt exist or pass is incorrect
        if not user:
...
#only logged users can access the route
